function winner() {
    ...
    const characters = ['Robert Arryn', 'Tommen Baratheon', 'Sandor Clegane', 'Theon Greyjoy', 'Tyrion Lannister', 'Oberyn Nymeros Martell', 'Lyanna Mormont', 'Arya Stark', 'Daenerys Targaryen', 'Margaery Tyrell']
